...
class UserTest < ActiveSupport::TestCase
  ...
  def setup
  	@user = User.new(name:"Example User", email: "me@example.com", password:"foobar", password_confirmation:"foobar")
  end
  ...
  test "email shouldnt be too long" do
  	@user.email = "a" * 255 + "@me.com"
  	assert_not @user.valid?
  end

  test "email validtation should accept valid addresses" do
